...
//	Extra attribute name table (stubs — real strings come from lua config)
...
bool MirGame::UserInitial()
{
	...
	{
		MessageBox(NULL, "��ʾ����ʾλ����Ϊ���ɫ(32λ),�����Ϊ���ɫ,������Ϸ���޷���������", MB_OK | MB_ICONERROR);
	}*/
#if _MSC_VER >= 1500
	// Set the double precision
	unsigned int uPrevPrecision;
	...
	{
		//	��½��Ϸ������ ��ClientSocket�ǵ�½������ ClientSocket2����Ϸ������ 2�����ض�λ
		if ( WSAAsyncSelect(g_xClientSocket.GetSocket(), hWnd, WM_SOCKMSG, FD_CONNECT|FD_READ|FD_CLOSE ) == SOCKET_ERROR)
		{
			wsprintf(strError, "WSAAsyncSelect() generated error %d\n", WSAGetLastError());
			OutputDebugString(strError);
	...
	{
		::MessageBox(NULL, "�ļ��汾��ƥ��", "����", MB_ICONERROR | MB_TASKMODAL);
		return false;
	}
	...
	{
		::MessageBox(NULL, "��ȡ����浵����ʧ��", "����", MB_ICONERROR | MB_TASKMODAL);
		return false;
	}
	...
	{
		::MessageBox(NULL, "��ȡ������Ϣʧ��", "����", MB_ICONERROR | MB_TASKMODAL);
		return false;
	}
...
bool MirGame::CheckParam()
{
	...
	{
		::MessageBox(NULL, "��Ϸ����ʧ�ܣ���ʹ�õ�½����½", "����", MB_ICONERROR);
		return false;
	}
	...
	{
		::MessageBox(NULL, "��Ϸ����ʧ�ܣ���ʹ�õ�½��(BMLauncher.exe)��½", "����", MB_ICONERROR);
		return false;
	}
	...
	case WM_ENTER_GAMESCENE:
		{
			...
			if(m_pxLoginScene->GetPage() == PAGE_LOAD)
			{
				...
				m_pGameScene->GetMainOpt()->GetChatDlg()->GetHistoryDlg()->InsertChatMessage("[����]��ӭ�����λش��������",ARGB_YELLOW);
				m_pGameScene->GetMainOpt()->GetChatDlg()->GetHistoryDlg()->InsertChatMessage("[��ʾ]�����������E����ѡ����Ϸ��������Ϸ��ͼ����ַ���뱾��Ϸ�޹أ���Ϊ�����ز�",ARGB_YELLOW);
				m_pGameScene->GetMainOpt()->GetChatDlg()->GetHistoryDlg()->InsertChatMessage("[��ʾ]CTRL+H ���Ĺ���ģʽ",ARGB_YELLOW);
				//m_pGameScene->GetMainOpt()->GetChatDlg()->GetHistoryDlg()->InsertChatMessage("[����]���� F9",ARGB_RED);
				//m_pGameScene->GetMainOpt()->GetChatDlg()->GetHistoryDlg()->InsertChatMessage("[����]���� F10",ARGB_RED);
				//m_pGameScene->GetMainOpt()->GetChatDlg()->GetHistoryDlg()->InsertChatMessage("[����]���� F11",ARGB_RED);
				//m_pGameScene->GetMainOpt()->GetChatDlg()->GetHistoryDlg()->InsertChatMessage("[����]���ͼ TAB",ARGB_RED);
				//m_pGameScene->GetMainOpt()->GetChatDlg()->GetHistoryDlg()->InsertChatMessage("[����]��ȡ �ո� �� CTRL��������",ARGB_RED);
				//m_pGameScene->GetMainOpt()->GetChatDlg()->GetHistoryDlg()->InsertChatMessage("[����]��ͼ CTRL+S",ARGB_RED);
