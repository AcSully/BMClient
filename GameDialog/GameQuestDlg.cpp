...
GameQuestDlg::GameQuestDlg()
{
	...
	//AddCommonButton(CBTN_CHECKBOX, 4, QUESTSUMMARY_WIDTH + 50, QUESTSUMMARY_TOP + 100, "������ɱ");
	...
	if(!m_xQuestInfoList.empty())
	{
		...
		for(int i = m_nShowIndex; i < m_nShowIndex + MAX_QUEST_LIST; ++i)
		{
			...
			if(begIter->stSummary.nType == 0)
			{
				...
				AfxGetPrinter()->PrintWithoutStroke(nRenderX, nRenderY, "����");
			}
			else
			{
				//	֧��
				AfxGetPrinter()->SetColor(ARGB_GREEN);
				AfxGetPrinter()->PrintWithoutStroke(nRenderX, nRenderY, "֧��");
			}
			...
			if(nQuestIndex == nSelectIndex)
			{
				...
				AfxGetPrinter()->PrintWithoutStroke(RELATIVE_X(QUESTCONTENT_LEFT), RELATIVE_Y(QUESTSUMMARY_TOP), "����˵����");
				++nContentLine;
				...
				//
				AfxGetPrinter()->SetColor(ARGB_RED);
				AfxGetPrinter()->PrintWithoutStroke(RELATIVE_X(QUESTCONTENT_LEFT), RELATIVE_Y(QUESTSUMMARY_TOP) + nContentLine * 13, "����Ҫ��");
				++nContentLine;
				...
				//
				AfxGetPrinter()->SetColor(ARGB_RED);
				AfxGetPrinter()->PrintWithoutStroke(RELATIVE_X(QUESTCONTENT_LEFT), RELATIVE_Y(QUESTSUMMARY_TOP) + nContentLine * 13, "��������");
				++nContentLine;
